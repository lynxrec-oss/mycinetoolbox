...
exports.stripeWebhook = exports.createStripeCheckoutSession = exports.wiseAdvisorChat = exports.trackPixelEvent = void 0;
 ...
 */
exports.trackPixelEvent = functions.https.onRequest(async (req, res) => {
    // Enable CORS
 ...
 */
exports.wiseAdvisorChat = functions.https.onCall(async (data, context) => {
